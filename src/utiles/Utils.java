...
public class Utils {
	 ...
	 /**
     * Este método obtendrá el driver para realizar las pruebas con:
     * <br>- Explorer
     * <br>- Chrome
     * @param
     */  
	...
	/**
	 * Método para generar una captura de pantalla en jpg con el nombre que se defina.
	 * @param
	 */  
	public static ArrayList<String> capturarPantalla(String casoDePrueba, ArrayList<String> pasos, String paso) throws AWTException, IOException {
	 ...
	 */
    public static void generarPDF (String casoDePrueba, ArrayList<String> pasos) throws MalformedURLException, FileNotFoundException {
